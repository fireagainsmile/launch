...
选择的优质卖单是赔率大于3单价大于5lamb的卖单。

![avatar](img/WXmk2@2x.png)

自动匹配购买空间只需要填写空间的大小和时长，例如购买2gb 3个月的空间
...
【暂时缺少配图】
 ...
 出售空间
 账户是矿工账户，这里会列出在市场中挂的卖单的列表
 
![avatar](img/WXmk3@2x.png)
在挖矿程序中完成了设备创建后，可以在钱包中挂设备的卖单
...
<code>
在弹出的对话框中选择设备，填写要卖的空间大小（一个设备如果已经挂一个卖单，就不能挂第二个了）
...
只有优质卖单会出现在市场的列表里面，供用户选择，普通的买单只能进行自动匹配
