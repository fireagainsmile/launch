...
测试网矿工和存储节点接入教程操作演示：https://pan.baidu.com/s/1j-defxC0y2gT_vKupwGcVA
...
下载安装包
```
wget https://github.com/LambdaIM/launch/releases/download/v0.1.1/lambda-storage-0.1.1-testnet.tar.gz
```
解压安装包
```
tar zxvf lambda-storage-0.1.1-testnet.tar.gz
```
进入解压后的目录
```
cd lambda-storage-0.1.1-testnet
```
